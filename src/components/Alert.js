...
const Alert = ({ dismissAlert }) => {
    return (
        <div
            ...
            className="p-4 mb-4 text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800 w-[30%]"
            role="alert"
        >
            <div className="flex items-center">
                ...
                <h3 className="text-lg font-medium">Item Added!</h3>
            </div>
            <div className="mt-2 mb-4 text-sm">Added to cart, go to checkout?</div>
            <div className="flex">
                <button
                    type="button"
